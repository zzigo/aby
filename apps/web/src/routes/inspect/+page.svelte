...
<style>
  ...
  .media-switch>span{color:var(--signal);font:9px ui-monospace,monospace;letter-spacing:.12em}.media-switch>small{justify-self:end;color:var(--muted);font:9px ui-monospace,monospace}.media-switch [role="tablist"]{display:flex;height:30px;padding:2px;background:#181a17}.media-switch button{min-width:92px;border:0;background:transparent;color:var(--muted);font:9px ui-monospace,monospace;letter-spacing:.08em}.media-switch button.active{background:var(--signal);color:#0c0d0c}
