...
<style>
  :global(body){margin:0;background:transparent}.share-shell{width:100%;height:100svh;background:transparent;color:#fff;overflow:hidden}.share-shell figure{position:relative;margin:0;height:100%;min-height:0;display:grid;grid-template-rows:minmax(0,1fr) auto;background:#000}.share-shell video{width:100%;height:100%;display:block;object-fit:contain}.share-shell audio{position:absolute;width:1px;height:1px;opacity:0}.share-play{position:absolute;left:12px;bottom:58px;padding:9px 13px;border:1px solid #ffffff55;background:#080908b8;color:#fff;font:9px ui-monospace,monospace;letter-spacing:.1em}.annotation{position:absolute;pointer-events:none;border:1px solid #c6ff52;color:#fff}.annotation:not([style]){left:50%;bottom:14%;transform:translateX(-50%);border:0}.annotation span{display:inline-block;padding:5px 7px;background:#080908d9;font:11px ui-monospace,monospace}figcaption{padding:9px 12px;display:grid;grid-template-columns:1fr auto;gap:2px 18px;background:#0b0c0beF}figcaption strong{font:italic 15px Georgia,serif}figcaption span{grid-row:2;color:#aeb2a8;font-size:10px}figcaption small{grid-row:1/3;grid-column:2;align-self:center;color:#7f837a;font:8px ui-monospace,monospace;letter-spacing:.1em}
</style>
